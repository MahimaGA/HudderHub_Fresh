    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                    $shop_id = array(); //empty array
                    $shop_id = shopid_key($connection); //shopidkey returns the id of shops of specific user in array
                    ...
                    if (oci_execute($result)) {
                        while (($row = oci_fetch_assoc($result)) != false) {
                            ...
                            $product_id = get_product_id($connection, $order_id); //using order id
                            $shop = get_shop_id($connection, $product_id); //using product id
