...
<body>
    ...
    <form action="update_account.php" method="post">
        ...
        <div class="col-md-12" style="margin-top: 10px;">
            ...
            <input type="text" class="form-control" placeholder="Mobile Number" name="number" value="<?php echo $contact; ?>">
        </div>
        <div class="col-md-12" style="margin-top: 10px;">
        ...
        <div class="mt-4 text-right">
            <button class="btn btn-dark profile-button" id="tbutton" type="submit" name="update_profile">Save Profile</button>
        </div>
    </form>
