...
<body>
    <div class="wrapper">
        <nav id="sidebar">
                <a class="navbar-logo" href="traderdash1.php">
                    <img src="images/finallogo.png" style="margin-left:30px; max-width:40px;" alt="HudderHub Logo">
                    <a style="font-family: Josefin Sans; font-weight: 600; color: black; text-decoration: none;" href="traderdash1.php">&nbsp;HudderHub Fresh</a>
                </a>
